...
chmod u+x ${code_dir}/xzq-laravel/docker/php/cron.sh
chmod 777 ${code_dir}/xzq-laravel/docker/php/cron.sh
...
php-fpm
#php /var/www/laravel/xzq-laravel/artisan swoole:http start
